...
class MicrophoneButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ReadingQuizBloc, ReadingQuizState>(
      builder: (context, state) {
        ...
        if (state.status == ReadingQuizStatus.listening ||
            state.status == ReadingQuizStatus.answered) {
          onTap = () {};
        } else {
          onTap = () => context.read<ReadingQuizBloc>().add(ListeningStarted());
        }
            ...
            GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: (state.status == ReadingQuizStatus.listening)
