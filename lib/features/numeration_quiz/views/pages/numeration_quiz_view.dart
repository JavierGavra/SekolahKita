...
class NumerationQuizView extends StatelessWidget {
  const NumerationQuizView({super.key});
  ...
  void _listener(BuildContext context, MultipleChoiceState state) {
    if (state.status == MultipleChoiceStateStatus.answered) {
      final snackBar = QuizSnackBar(
        onOk: () {},
        correctAnswer: state.question!.correctAnswerId,
      );
  ...
  Widget _buildAnswerGrid(
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final isCorrectAnswer = option.id == question.correctAnswerId;
        ...
        return GestureDetector(
          onTap: isAnswered
              ? null
              : () =>
                    context.read<MultipleChoiceCubit>().selectAnswer(option.id),
